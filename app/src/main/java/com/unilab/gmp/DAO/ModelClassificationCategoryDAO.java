...
@Dao
public interface ModelClassificationCategoryDAO  {
    @Query("select * from ModelClassificationCategory")
    Flowable<List<ModelClassificationCategory>> getList();
...
//                                                 String create_date,String rowid);
    ...
    @Insert
    Completable insert(final ModelClassificationCategory modelClassificationCategory);


    @Query("DELETE FROM ModelClassificationCategory")
    void delete();
}
