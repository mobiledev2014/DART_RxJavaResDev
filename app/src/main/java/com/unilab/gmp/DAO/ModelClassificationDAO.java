...
@Dao
public interface ModelClassificationDAO {
    @Query("select * from ModelClassification")
    Flowable<List<ModelClassification>> getList();
...
//                                                 String create_date,String rowid);
    ...
    @Insert
    Completable insert(final ModelClassification modelClassifications);


    @Query("DELETE FROM ModelClassification")
    void delete();
